...
import { AchievementsSection } from '@/core/components/scout-management/AchievementsSection';
import { getAchievementLeaderboard } from '@/core/lib/achievementUtils';
                  ...
                  {leaderboard.slice(0, 10).map((entry, index) => (
                    ...
                    >
                      <div className="flex items-center justify-center w-6 h-6">
                        {index < 3 ? (
                          <Badge
                            ...
                            className={
                              index === 0
                                ? 'bg-yellow-500 hover:bg-yellow-600' // Gold
                                : index === 1
                                  ? 'bg-gray-400 hover:bg-gray-500' // Silver
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="font-medium text-sm truncate">{entry.scoutName}</div>
                        <div className="flex items-center gap-2 text-xs text-gray-500">
                          ...
                          <span className="flex items-center gap-1">
                            <Award className="h-3 w-3" />+{entry.totalStakesFromAchievements}
                          </span>
                        </div>
                        {entry.recentUnlock && (
