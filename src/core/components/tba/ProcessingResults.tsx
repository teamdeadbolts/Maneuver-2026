        ...
        <div className="p-4 bg-green-50 dark:bg-green-950/20 rounded-lg border border-green-200 dark:border-green-800">
          <div className="space-y-2 sm:space-y-0 sm:flex sm:justify-between sm:items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-6 text-green-700 dark:text-green-300">
              ...
              <span className="font-semibold text-lg">{totalStakes} stakes awarded</span>
            </div>
          </div>
        </div>
      </CardHeader>
        ...
        <div className="space-y-4">
          {results.map(result => (
            ...
            >
              ...
              <div className="space-y-2 sm:hidden">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-gray-600 dark:text-gray-300 text-sm">
                    Predictions:{' '}
                    <span className="font-medium">
                      {result.correctPredictions}/{result.predictionsCount}
                    </span>
              ...
              {/* Desktop layout: Single row with three groups */}
