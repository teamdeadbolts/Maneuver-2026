/**
 * Alliance Table Component
 *
 * Table showing all alliances with team selectors.
            ...
            <thead>
              <tr className="border-b">
                ...
                <th className="text-left p-3 font-semibold min-w-[120px]">
                  <div className="flex items-center gap-2">Captain</div>
                </th>
                <th className="text-left p-3 font-semibold min-w-[120px]">
                  <div className="flex items-center gap-2">Pick 1</div>
                </th>
                <th className="text-left p-3 font-semibold min-w-[120px]">
                  <div className="flex items-center gap-2">Pick 2</div>
                </th>
                <th className="text-left p-3 font-semibold min-w-[120px]">
                  <div className="flex items-center gap-2">Pick 3</div>
                </th>
