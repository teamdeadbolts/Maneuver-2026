      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="text-right min-w-16 font-bold">{selectedMetricLabel}</TableHead>
              ...
              <TableRow key={scout.name}>
                <TableCell className="font-medium">
                  <Badge
                    ...
                    className={
                      index === 0
                        ? 'bg-yellow-500 text-white hover:bg-yellow-600' // Gold
                        : index === 1
                          ? 'bg-gray-400 text-black hover:bg-gray-500' // Silver
                          : index === 2
                            ? 'bg-amber-600 text-white hover:bg-amber-700' // Bronze
                            : ''
                    }
                  >
                    {index + 1}
