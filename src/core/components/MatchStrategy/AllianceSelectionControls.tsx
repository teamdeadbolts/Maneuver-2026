      ...
      <div className="flex flex-col md:flex-row md:items-center gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <GenericSelector
            ...
            availableOptions={[
              'none',
              ...confirmedAlliances.map(alliance => alliance.id.toString()),
            ]}
            ...
            buttonDisplayFormat={value => {
              ...
              const alliance = confirmedAlliances.find(a => a.id.toString() === value);
              return alliance
                ? `Blue Alliance: Alliance ${alliance.allianceNumber}`
                : `Blue Alliance: Alliance ${value}`;
            }}
          ...
          <GenericSelector
            ...
            buttonDisplayFormat={value => {
              ...
              const alliance = confirmedAlliances.find(a => a.id.toString() === value);
              return alliance
                ? `Red Alliance: Alliance ${alliance.allianceNumber}`
                : `Red Alliance: Alliance ${value}`;
            }}
            className="w-full sm:w-40"
          />
        </div>
