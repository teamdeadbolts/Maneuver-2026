  ...
  return (
    <div className="flex md:justify-between w-full flex-wrap md:flex-nowrap gap-2 pt-4">
      ...
      <div className="flex items-center md:justify-end w-full md:w-auto gap-2">
        <Button onClick={onClearAll} variant="outline" className="flex-1 md:flex-none px-3 py-2">
          Clear All
        </Button>
        <Button onClick={onSaveAll} variant="outline" className="flex-1 md:flex-none px-3 py-2">
          Save All
        </Button>
      </div>
    </div>
