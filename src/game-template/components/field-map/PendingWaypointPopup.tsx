  ...
  const canConfirm = isClimb
    ? isSelectingClimbTime
      ...
      : skipClimbOutcomeSelection
        ...
        : climbStartTimeSecRemaining !== null &&
          (climbWithLevels
            ? climbLevel !== undefined && climbResult !== null
            : climbResult !== null)
    : accumulatedFuel > 0;
            ...
            <CardTitle className="text-lg font-bold tracking-tight">
              {isClimb
                ? isSelectingClimbTime
                  ...
                  : climbWithLevels
                    ? climbLevel
                      ? `L${climbLevel} - Select Outcome`
                      : 'Select Level'
                    : 'Climb Outcome'
                : accumulatedFuel > 0
                  ? `Total: +${accumulatedFuel}`
                  : 'Select Amount'}
            </CardTitle>
          </div>
        </CardHeader>
          ...
          {isClimb ? (
            isSelectingClimbTime ? (
              <div className="space-y-3 p-2">
                <div className={cn('grid gap-2', climbWithLevels ? 'grid-cols-3' : 'grid-cols-4')}>
                  {climbTimePresets.map(seconds => (
                    <Button
                      ...
                      onClick={() =>
                        setClimbStartTimeSecRemaining(prev => (prev === seconds ? null : seconds))
                      }
                      className="h-11"
                    >
                ...
                >
                  <Button
                    ...
                    className={cn(
                      ...
                      climbResult === 'success' &&
                        'bg-blue-600 hover:bg-blue-700 border-blue-400 text-white shadow-lg'
                    )}
                  >
                  ...
                  {allowClimbFail && (
                    <Button
                      ...
                      className={cn(
                        'h-20 flex flex-col gap-1 items-center justify-center border-2 transition-all rounded-xl',
                        climbResult === 'fail' &&
                          'bg-red-600 hover:bg-red-700 border-red-400 text-white shadow-lg'
                      )}
                    >
