      ...
      {selectedLevel && (
        <div className="flex gap-2">
          ...
          <Button
            ...
            onClick={e => {
              e.stopPropagation();
              handleResultToggle('fail');
            }}
            className={cn('font-bold', selectedResult === 'fail' && 'bg-red-600 hover:bg-red-500')}
          >
      ...
      <div className="flex items-center justify-center gap-2 mt-2">
        ...
        {selectedLevel && (
          <Button
            ...
            onClick={e => {
              e.stopPropagation();
              onSelect(selectedLevel, selectedResult);
            }}
