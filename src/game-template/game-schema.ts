...
export const strategyColumns = {
  ...
  auto: {
    ...
    autoShotOnTheMoveRate: {
      label: 'Auto Shot On Move %',
      visible: true,
      numeric: true,
      percentage: true,
    },
    autoShotStationaryRate: {
      label: 'Auto Shot Stationary %',
      visible: true,
      numeric: true,
      percentage: true,
    },
    autoClimbRate: { label: 'Auto Climb %', visible: true, numeric: true, percentage: true },
    'rawValues.autoClimbStartTimeSec': {
      label: 'Auto Climb Start (s)',
      visible: true,
      numeric: true,
    },
    'rawValues.autoTrenchStuckDuration': {
      label: 'Auto Trench Stuck',
      visible: false,
      numeric: true,
    },
  ...
  teleop: {
    ...
    teleopShotOnTheMoveRate: {
      label: 'Teleop Shot On Move %',
      visible: true,
      numeric: true,
      percentage: true,
    },
    teleopShotStationaryRate: {
      label: 'Teleop Shot Stationary %',
      visible: true,
      numeric: true,
      percentage: true,
    },
    ...
    'endgame.usedTrenchInTeleopRate': {
      label: 'Used Trench %',
      visible: false,
      numeric: true,
      percentage: true,
    },
    'endgame.usedBumpInTeleopRate': {
      label: 'Used Bump %',
      visible: false,
      numeric: true,
      percentage: true,
    },
    'endgame.passedToAllianceFromNeutralRate': {
      label: 'Passed Neutral → Alliance %',
      visible: false,
      numeric: true,
      percentage: true,
    },
    'endgame.passedToAllianceFromOpponentRate': {
      label: 'Passed Opponent → Alliance %',
      visible: false,
      numeric: true,
      percentage: true,
    },
    'endgame.passedToNeutralRate': {
      label: 'Passed Opponent → Neutral %',
      visible: false,
      numeric: true,
      percentage: true,
    },
    'rawValues.teleopTrenchStuckDuration': {
      label: 'Trench Stuck (s)',
      visible: true,
      numeric: true,
    },
  ...
  endgame: {
    'rawValues.endgameClimbStartTimeSec': {
      label: 'Endgame Climb Start (s)',
      visible: true,
      numeric: true,
    },
...
export const strategyPresets: Record<string, string[]> = {
  ...
  auto: [
    'teamNumber',
    'matchCount',
    'rawValues.autoPoints',
    'rawValues.autoFuel',
    'rawValues.scaledAutoFuel',
    'fuelAutoOPR',
    'autoShotOnTheMoveRate',
    'autoShotStationaryRate',
    'autoClimbRate',
  ...
  teleop: [
    'teamNumber',
    'matchCount',
    'rawValues.teleopPoints',
    'rawValues.teleopFuel',
    'rawValues.scaledTeleopFuel',
    'fuelTeleopOPR',
    'teleopShotOnTheMoveRate',
    'teleopShotStationaryRate',
    'rawValues.teleopFuelPassed',
    'endgame.usedTrenchInTeleopRate',
    'endgame.usedBumpInTeleopRate',
    'endgame.passedToAllianceFromNeutralRate',
    'endgame.passedToAllianceFromOpponentRate',
